            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <li class="menu-item {{ \Route::currentRouteName() == 'send_message' ? 'active' : '' }}">
                        <a href="{{ route('send_message') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Send Message</a>
                    </li>

                    {{-- <a href="form.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Send Message</a> --}}
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Reports</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            {{-- <img class="rounded-circle me-lg-2" alt=""
                                style="width: 40px; height: 40px;"> --}}
